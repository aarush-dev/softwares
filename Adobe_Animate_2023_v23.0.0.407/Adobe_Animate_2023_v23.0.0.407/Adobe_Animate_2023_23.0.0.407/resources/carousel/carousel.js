...
function showSlides() {
   ...
   for (i = 0; i < slides.length; i++) {
    ...
    setTimeout(showSlides, 22000); // Change image every 22.00 seconds
}
...
function cecDisplayContent(data, locale)
{
	...
	var url = "https://www.adobe.com/"+lcl.toLowerCase()+"/products/animate.html";
	if(locale == "en_us" || locale == "en_US") {
		  url = "https://www.adobe.com/products/animate.html";
	  }
	if(locale == "zh_tw" || locale == "zh_TW") {
		  url = "https://www.adobe.com/tw/products/animate.html";
	  }
